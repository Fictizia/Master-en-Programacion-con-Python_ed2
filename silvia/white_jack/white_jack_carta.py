...
player_points = give_a_card()  # Contador de puntos del jugador
bank_points = give_a_card()  # Contador de puntos de la banca
print(f'Tienes {player_points} puntos')
